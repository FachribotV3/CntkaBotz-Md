...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    let fla = 'https://telegra.ph/file/ccf4e6dfe472f1c25fd93.jpgtType=1&fillTextPattern=Warning'
    let teks = 'Menu'
  ...
  await conn.reply(m.chat, '*Loading...*', ftroli)
   ...
   await conn.sendButtonImg(m.chat, `*${wish()}, ${name} 👋*`, text.trim(), fla, [['Donasi', _p + 'donasi'], ['Owner', _p + 'owner']], false, { quoted: ftroli, contextInfo: { externalAdReply: { showAdAttribution: true,
    title: wm2,  
