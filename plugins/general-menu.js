...
let handler = async (m, { conn, usedPrefix: _p }) => {
  ...
  await conn.reply(m.chat, '*Loading...*', ftroli)
   ...
   await conn.sendButton(m.chat, `*${wish()}, ${name} 👋*`, text.trim(), fla + teks, [['Donasi', _p + 'donasi'], ['Owner', _p + 'owner']], false, { quoted: ftroli, contextInfo: { externalAdReply: { showAdAttribution: true,
    title: wm2,  
