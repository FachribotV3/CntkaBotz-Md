...
'https://tinyurl.com/2c82ajhq', 'https://tinyurl.com/265y8p3e', 'https://tinyurl.com/286yslxu'])
		...
		// Fake 🤥
		global.ftroli = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 2022, status: 1, surface: 1, message: wm, orderTitle: wm, thumbnail: await (await fetch('https://telegra.ph/file/bff41df0f2425037818d7.jpg')).buffer(), sellerJid: '0@s.whatsapp.net' } } }
